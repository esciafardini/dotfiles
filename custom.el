(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-collection flycheck-clj-kondo yasnippet lsp-treemacs evil-leader evil-nerd-commenter lispyville simpleclip cider key-chord clojure-mode yaml-mode web-mode lsp-ui lsp-mode json-mode js2-mode rainbow-mode elisp-slime-nav rainbow-delimiters company counsel swiper ivy exec-path-from-shell zop-to-char zenburn-theme which-key volatile-highlights undo-tree super-save smartrep smartparens operate-on-number nlinum move-text magit projectile imenu-anywhere hl-todo guru-mode git-modes git-timemachine gist flycheck expand-region epl editorconfig easy-kill diminish diff-hl discover-my-major crux browse-kill-ring anzu ag ace-window)))
(custom-set-faces
...
(fset 'new-stapler
   (kmacro-lambda-form [?w ?h ?v ?0 ?x ?i ?\C-? escape] 0 "%d"))
(evil-set-register ?s [?w ?h ?v ?0 ?x ?i ?\C-? escape])
...
(evil-leader/set-key 
 ...
 "b" 'ivy-switch-buffer
 "f" 'counsel-find-file
 "-" 'switcherooo       ;;switch btw current & last buffer
 )
